 ...
 */
public class QuantityCenterNodePlugin extends Plugin {
    // The shared instance.
    private static QuantityCenterNodePlugin plugin;

    /**
     * The constructor.
     */
    public QuantityCenterNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static QuantityCenterNodePlugin getDefault() {
        return plugin;
    }
